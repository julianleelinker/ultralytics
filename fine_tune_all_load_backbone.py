...
# results = model.train(data=data_yaml, epochs=100, imgsz=640, name='test', batch=64, freeze=9)
results = model.train(data=data_yaml, epochs=100, imgsz=640, name='tiip-yolov8m-v0.1.2-0726-resize-nofreeze', batch=32)
